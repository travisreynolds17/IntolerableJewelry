...
python:
    ...
    default cassBio = Biography("Cassandra Sanna", "", "", 22, "Ultramarine", [])
    default lichBio = Biography("Lichelle Carpenter", "", "", 25, "Carmine Red", [])
    default robinBio = Biography("Robin Godfrey", "", "", 24, "Royal Purple", [])
    ...
    default taniaBio = Biography("Tania van der Waal", "", "", 26, "Tuscan Sun", [])
