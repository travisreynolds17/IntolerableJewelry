label common2:
    ...
    $chat.addmessage(liv, "Me, too, Shub-Nickelrath :)")

    ki "I wonder if Tania had time to put her idea for Cassandra in place yet." 
    
    $chat.addmessage(shub, "Yo Elsa, what'd you two chat about. you n Liv")
    ...
    $chat.addmessage(liv, "LOL") 
    
    $chat.addmessage(elsa, "Yes, if you have to know.")
    ...
    $chat.addmessage(elsa, "That's interesting. Kylie's definitely there though.")
    ...
    c "< I'm not an alcoholic and you're a trash actress. And a cheapskate. I make ten times the money playing anywhere else in this country! >" 
    ...
    $chat.addmessage(liv, "Back. This part breaks my heart :(")
    ...
    r "You shouldn't have, no. And I should not have called you an alcoholic." 
    
    $chat.addmessage(bar, "Kiss and make up")

    r "Kylie. I have loved you for a quarter of my life. I could not let this chance slip past!" 
    ...
    $chat.addmessage(liv, "My heart! It's breaking!")
    ...
    $chat.addmessage(fizz, "Didn't you just drink like a minute ago?")
    ...
    s "Well... I guess I will get that drink. If you care at all, I'll be back in thirty."
